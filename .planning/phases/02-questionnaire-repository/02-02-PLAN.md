...
files_modified:
  ...
  - data/questionnaires/vision_ophthalmology.json
  - data/questionnaires/pharmacy.json
  - data/questionnaires/chiropractic.json
  - data/questionnaires/app_nurse_practitioner.json
  - data/questionnaires/app_physician_assistant.json
  - data/questionnaires/app_certified_nurse_midwife.json
  - data/questionnaires/app_certified_registered_nurse_anesthetist.json
  - data/questionnaires/behavioral_psychiatry.json
  - data/questionnaires/behavioral_psychology.json
  - data/questionnaires/behavioral_counseling.json
  - data/questionnaires/behavioral_social_work.json
  - data/questionnaires/behavioral_addiction.json
  - data/questionnaires/behavioral_marriage_family.json
  - data/questionnaires/behavioral_school_counselor.json
  - data/questionnaires/behavioral_applied_behavior.json
  - data/questionnaires/rehab_physical_therapy.json
  - data/questionnaires/rehab_occupational_therapy.json
  - data/questionnaires/rehab_speech_language.json
  - data/questionnaires/rehab_respiratory_therapy.json
  - data/questionnaires/rehab_audiologist.json
  - data/questionnaires/nutrition_dietetics.json
  - data/questionnaires/nutrition_nutritionist.json
  - data/questionnaires/midlevel_medical_assistant.json
  - data/questionnaires/midlevel_surgical_technologist.json
  - data/questionnaires/midlevel_surgical_assistant.json
  - data/questionnaires/midlevel_anesthesia_technologist.json
  - data/questionnaires/midlevel_dialysis_technician.json
  - data/questionnaires/midlevel_phlebotomist.json
  - data/questionnaires/midlevel_paramedic.json
  - data/questionnaires/midlevel_emt.json
  - data/questionnaires/diagnostics_radiology_technologist.json
  - data/questionnaires/diagnostics_mri_technologist.json
  - data/questionnaires/diagnostics_ct_technologist.json
  - data/questionnaires/diagnostics_ultrasound_technologist.json
  - data/questionnaires/diagnostics_nuclear_medicine_technologist.json
  - data/questionnaires/diagnostics_eeg_technologist.json
  - data/questionnaires/diagnostics_ecg_technologist.json
  - data/questionnaires/lab_clinical_laboratory_scientist.json
  - data/questionnaires/lab_medical_laboratory_technician.json
  - data/questionnaires/lab_histotechnologist.json
  - data/questionnaires/lab_cytotechnologist.json
  - data/questionnaires/lab_pathologists_assistant.json
  - data/questionnaires/health_informatics.json
  - data/questionnaires/case_management.json
...
must_haves:
  ...
  key_links:
    - from: "data/questionnaires/physician.json"
      ...
      pattern: "chart\\.|order\\.|perform\\.|interpret\\.|educate\\.|coordinate\\."
...
6. **diagnostic_ordering** (boolean) -- "Do you order diagnostic tests (lab work, imaging, pathology)?" Maps to `scope.permitted_actions`. If true, grants: order.lab_test, order.imaging, order.pathology.

7. **results_interpretation** (boolean) -- "Do you interpret diagnostic results (lab values, imaging, EKG/EEG)?" Maps to `scope.permitted_actions`. If true, grants: interpret.lab_result, interpret.imaging, interpret.ekg, interpret.eeg.
...
11. **care_coordination** (boolean) -- "Do you coordinate care with other providers (referrals, transitions, team conferences)?" Maps to `scope.permitted_actions`. If true, grants: coordinate.referral, coordinate.care_transition, coordinate.team_conference.

12. **billing** (boolean) -- "Do you submit professional billing/coding?" Maps to `scope.permitted_actions`. If true, grants: charge.professional_fee, charge.facility_fee (if applicable to physician per taxonomy).
...
IMPORTANT: Cross-reference EVERY action ID in grants arrays against the actual taxonomy v1.0.0.json. Only use action IDs that exist. If an action ID from the outline above does not exist in the taxonomy, omit it or use the correct ID.
